...
text_about1 :
DB 'SNAKE GAME ON x86 PROCESSOR',0

text_about2 :
DB 'Made by ARUNAVA,GOWTHAM,NAGHUL',0

text_about3 :
DB 'This game is a copy of the retro snake game !',0
...
text_end :
DB 'SNAKE GAME ON x86 PROCESSOR',10,13
DB 'Made by ARUNAVA,GOWTHAM,NAGHUL',10,13,10,13
DB 'Copy of the retro snake game !',10,13
